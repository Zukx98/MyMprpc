...
inline void RegisterResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mprpc.RegisterResponse.result)
}
...
inline ::mprpc::ResultCode* RegisterResponse::unsafe_arena_release_result() {
