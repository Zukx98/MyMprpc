...
inline void GetFriendListResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mprpc.GetFriendListResponse.result)
}
...
inline ::mprpc::ResultCode* GetFriendListResponse::unsafe_arena_release_result() {
